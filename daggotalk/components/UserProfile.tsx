...
const makeupStyles = ["Natural", "Glam", "Soft Glam", "Everyday", "Creative", "Minimalist", "Bold & Dramatic", "Vintage"];
const skinConcerns = ["Sensitive Skin", "Acne-prone", "Redness", "Fine Lines & Wrinkles", "Large Pores", "Dry Patches", "Dullness", "Hyperpigmentation", "Uneven Texture", "Oily T-Zone", "Blackheads", "Under-eye Circles"];
const makeupFinishes = ["Matte", "Dewy", "Satin", "Radiant", "Natural", "Velvet"];
const productPriorities = ["Long-wear", "Hydrating", "Lightweight", "Full Coverage", "Buildable Coverage", "SPF Protection", "Vegan", "Cruelty-Free", "Clean Ingredients", "Transfer-proof", "Non-comedogenic", "Brightening"];
const productAvoidances = ["Glitter", "Heavy Fragrance", "Talc", "Silicone", "Parabens", "Sulfates", "Drying Alcohols", "Essential Oils"];
    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-center p-4 animate-fade-in" onClick={onClose}>
      <div className="bg-white dark:bg-gray-800 p-6 sm:p-8 rounded-2xl shadow-2xl max-w-lg w-full relative max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Product Priorities (What you look for)</label>
            <div className="mt-2 grid grid-cols-2 gap-2">
